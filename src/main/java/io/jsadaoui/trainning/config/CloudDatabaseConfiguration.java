package io.jsadaoui.trainning.config;
...
@Configuration
@EnableMongoRepositories("io.jsadaoui.trainning.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("io.jsadaoui.trainning.config.dbmigrations");
